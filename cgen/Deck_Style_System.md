# Executive Deck Style System — Reproduction Guide

A client-agnostic specification for building polished, calm, senior-friendly slide decks
in the style of the AMT Operating Model deck. Built with **pptxgenjs** (from-scratch),
**react-icons + sharp** for icons, and a LibreOffice render-and-QA loop.
...
- Pick exactly **one** dominant accent. If the brand has several, the others appear only as
  rare single-use highlights — never give colors equal weight (60–70% white, accent is the spark).
...
**Do**
- Keep 60–70% of the deck white; let the accent be the spark.
